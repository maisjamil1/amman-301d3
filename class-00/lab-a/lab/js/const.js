...
function displayPics(){
  ...
  //because    const rando = makeRandom();  was inside while block(local variable) and the console can not access it.
  console.log(viewed);
...
function handleClick(event) {
  ...
  totalClicks += 1;//the value changed so i need let i can not use const
  if(totalClicks > 24) {
